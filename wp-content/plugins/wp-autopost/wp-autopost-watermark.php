...
function updateOption(){
  ...
  document.getElementById("myform").action='admin.php?page=wp-autopost/wp-autopost-watermark.php';
...
function preview(){
  ...
  document.getElementById("myform").action='admin.php?page=wp-autopost/wp-autopost-watermark.php#preview_pic';
  document.getElementById("myform").submit();
}
</script>
