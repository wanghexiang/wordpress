...
?> 
 <form id="myform" method="post" action="admin.php?page=wp-autopost/wp-autopost-options.php">
  <div class="postbox">
  <h3 class="hndle" style="cursor:pointer;"><?php echo __('Update Option','wp-autopost'); ?></h3>
  <div class="inside">
	 <table width="100%"> 	         	  
       <tr> 
		 <td width="15%"><?php echo __('Update Method','wp-autopost'); ?>:</td>
		 <td><div>
	   ...
	   <tr>
         <td width="10%"><?php echo __('Time Limit on Updates','wp-autopost'); ?>:</td>
