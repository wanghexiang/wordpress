...
if($_GET['oauth_verifier']!=''){ // process callback
...
<div class="wrap">
  ...
  <h2 class="nav-tab-wrapper">
   <a href="admin.php?page=wp-autopost/wp-autopost-flickr.php" class="nav-tab <?php if($tab=='default') echo 'nav-tab-active';?>"><?php _e( 'Flickr Options', 'wp-autopost' );?></a>
   <a href="admin.php?page=wp-autopost/wp-autopost-flickr.php&tab=uploaded_images" class="nav-tab <?php if($tab=='uploaded_images') echo 'nav-tab-active';?>"><?php _e( 'Uploaded Images', 'wp-autopost' );?></a>
  </h2>
<?php 
switch ($tab){
 case 'default':
...
if($Flickr['oauth_token']==''): ?>
 ...
 <div>
  ...
  <a href="admin.php?page=wp-autopost/wp-autopost-flickr.php&wp_autopost_flickr_request_token=true" class="button button-primary button-hero load-customize" ><?php _e( 'Click here to authentication', 'wp-autopost' );?></a>
...
<?php } ?>
  ...
  <tr>
    <td colspan="2">
	 <a href="admin.php?page=wp-autopost/wp-autopost-flickr.php&log_out=true" class="button"><?php _e( 'Log Out');?></a>
	</td>
  </tr>
</table>
...
<?php
  if($re!=null){
?>
<form action="admin.php?page=wp-autopost/wp-autopost-flickr.php" method="post">
...
<ul class='subsubsub'>
	<li><a href="admin.php?page=wp-autopost/wp-autopost-flickr.php&tab=uploaded_images&mode=image" <?php if($mode=='image'||$mode==NULL)  echo 'class="current"'; ?> ><?php echo __('Image View','wp-autopost'); ?> <span class="count">(<?php echo number_format($ImgTotal);?>)</span></a> |</li>

	<li><a href="admin.php?page=wp-autopost/wp-autopost-flickr.php&tab=uploaded_images&mode=post" <?php if($mode=='post') echo 'class="current"'; ?> ><?php echo __('Post View','wp-autopost'); ?> <span class="count">(<?php echo number_format($PostTotal);?>)</span></a> </li>
</ul>
