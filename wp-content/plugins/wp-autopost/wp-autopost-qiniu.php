...
<div class="wrap">
  ...
  <h2 class="nav-tab-wrapper">
   <a href="admin.php?page=wp-autopost/wp-autopost-qiniu.php" class="nav-tab <?php if($tab=='default') echo 'nav-tab-active';?>"><?php _e( 'Qiniu Options', 'wp-autopost' );?></a>
   <a href="admin.php?page=wp-autopost/wp-autopost-qiniu.php&tab=uploaded_images" class="nav-tab <?php if($tab=='uploaded_images') echo 'nav-tab-active';?>"><?php _e( 'Uploaded Images', 'wp-autopost' );?></a>
  </h2>
<?php 
switch ($tab){
 case 'default':
...
<form action="admin.php?page=wp-autopost/wp-autopost-qiniu.php" method="post">
...
<ul class='subsubsub'>
	<li><a href="admin.php?page=wp-autopost/wp-autopost-qiniu.php&tab=uploaded_images&mode=image" <?php if($mode=='image'||$mode==NULL)  echo 'class="current"'; ?> ><?php echo __('Image View','wp-autopost'); ?> <span class="count">(<?php echo number_format($ImgTotal);?>)</span></a> |</li>

	<li><a href="admin.php?page=wp-autopost/wp-autopost-qiniu.php&tab=uploaded_images&mode=post" <?php if($mode=='post') echo 'class="current"'; ?> ><?php echo __('Post View','wp-autopost'); ?> <span class="count">(<?php echo number_format($PostTotal);?>)</span></a> </li>
</ul>
